...
rps_gesture = {0:'rock', 5:'paper', 9:'scissors', 8:'spiderman'}
    ...
    if result.multi_hand_landmarks is not None:
        ...
        for res in result.multi_hand_landmarks:
            ...
            if len(rps_result) >= 2:
                ...
                elif rps_result[0]['rps']=='spiderman':
                    if rps_result[1]['rps']=='spiderman'     : text = 'Rock wins'   ; winner = 1
                    elif rps_result[1]['rps']=='spiderman'  : text = 'Scissors wins'; winner = 0
                    elif rps_result[1]['rps']=='spiderman': text = 'Tie'
